...
typealias FontScale = Float

/**
 * Extension function to scale TextUnit values with a factor
 */
fun FontScale.scale(textUnit: TextUnit): TextUnit {
    return (textUnit.value * this).sp
}
 ...
 */
fun calculateFontScale(screenWidth: Float, screenHeight: Float): FontScale =
    minOf(
        screenWidth / 383f,
        screenHeight / 832f,
        1.2f
